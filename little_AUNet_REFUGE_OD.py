...
PATH = "/home/dipayan/Anupam/dataset/8.REFUGE"
train_image_dir = os.path.join(PATH, "training/images")
train_ann_dir = os.path.join(PATH, "training/ground_truth/OD")
val_image_dir = os.path.join(PATH, "validation/images")
val_ann_dir = os.path.join(PATH, "validation/ground_truth/OD")
...
def get_dataloaders(img_size = 256, batch_size = 16, image_dir = None, ann_dir = None, train_image_dir = None, val_ann_dir = None, train_image_names = None, train_ann_names = None, val_image_names = None, val_ann_names = None):
    ...
    train_transforms = A.Compose([
        A.PadIfNeeded(min_height=2124, min_width=2124, border_mode=cv2.BORDER_CONSTANT, p=1),
...
def test_model():
    mod = UNet(in_c=3, n_classes=2, layers=[8,16,32,64], conv_bridge=True, shortcut=True)
...
model = UNet(in_c=3, n_classes=2, layers=[8,16,32], conv_bridge=True, shortcut=True)
model.to(device)
...
checkpoint_dir = "/home/dipayan/Anupam/REFUGE/Little_AUNet/weights"
save_dir = "/home/dipayan/Anupam/REFUGE/Little_AUNet/weights"
...
model_path = "/home/dipayan/Anupam/REFUGE/Little_AUNet/weights"
...
plt.savefig('/home/dipayan/Anupam/REFUGE/Little_AUNet.png')
plt.show()