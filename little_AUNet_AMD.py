...
PATH = "/home/dipayan/Anupam/dataset/4.AMD"
train_image_dir = os.path.join(PATH, "training/images")
train_ann_dir = os.path.join(PATH, "training/ground_truth/RV/BDP")
val_image_dir = os.path.join(PATH, "validation/images")
val_ann_dir = os.path.join(PATH, "validation/ground_truth/RV/BDP")
...
def test_model():
    mod = UNet(in_c=3, n_classes=2, layers=[4,8,16,24], conv_bridge=True, shortcut=True)
    #x = torch.randn((1, 3, 512, 512))
    #mod.cuda()
    #pred = mod(x)
    #print(stat(mod, input_size=(3, 512, 512)))
    #print(summary(mod, input_size=(1, 3, 1024, 1024)))
    macs, params = get_model_complexity_info(mod, (3, 768, 768),
                                             as_strings=True,
...
model = UNet(in_c=3, n_classes=2, layers=[4,8,16,24], conv_bridge=True, shortcut=True)
model.to(device)
...
checkpoint_dir = "/home/dipayan/Anupam/AMD/Little_AUNet2/weights"
save_dir = "/home/dipayan/Anupam/AMD/Little_AUNet2/weights"
...
model_path = "/home/dipayan/Anupam/AMD/Little_AUNet2/weights"
...
plt.savefig('/home/dipayan/Anupam/AMD/Little_AUNet2.png')
plt.show()