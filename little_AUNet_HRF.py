...
PATH = "/home/dipayan/Anupam/dataset/1.HRF"
...
def get_dataloaders(img_size = 256, batch_size = 16, image_dir = None, ann_dir = None, train_image_dir = None, val_ann_dir = None, train_image_names = None, train_ann_names = None, val_image_names = None, val_ann_names = None):
    ...
    train_transforms = A.Compose([
        A.PadIfNeeded(min_height=3504, min_width=3504, p=1),
    ...
    val_transforms = A.Compose([
        A.PadIfNeeded(min_height=3504, min_width=3504, border_mode=cv2.BORDER_CONSTANT, p=1),
        A.Resize(height = img_size, width = img_size, always_apply =True),
        A.Normalize(
        mean = (0, 0, 0), std = (1.0, 1.0, 1.0), max_pixel_value = 255.0
        ),
...
def test_model():
    ...
    macs, params = get_model_complexity_info(mod, (3, 2048, 2048),
                                             as_strings=True,
...
checkpoint_dir = "/home/dipayan/Anupam/HRF/Little_AUNet/weights"
save_dir = "/home/dipayan/Anupam/HRF/Little_AUNet/weights"
...
model_path = "/home/dipayan/Anupam/HRF/Little_AUNet/weights"
...
plt.savefig('/home/dipayan/Anupam/HRF/Little_AUNet.png')
plt.show()