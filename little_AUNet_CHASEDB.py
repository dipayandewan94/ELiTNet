...
PATH = "/home/dipayan/Anupam/dataset/5.CHASEDB"
...
def get_dataloaders(img_size = 256, batch_size = 16, image_dir = None, ann_dir = None, train_image_dir = None, val_ann_dir = None, train_image_names = None, train_ann_names = None, val_image_names = None, val_ann_names = None):
    ...
    val_transforms = A.Compose([
        A.PadIfNeeded(min_height=img_size, min_width=img_size, border_mode=cv2.BORDER_CONSTANT, p=1),
        A.Normalize(
        mean = (0, 0, 0), std = (1.0, 1.0, 1.0), max_pixel_value = 255.0
        ),
        ToTensorV2()
...
checkpoint_dir = "/home/dipayan/Anupam/CHASEDB/Little_AUNet/weights"
save_dir = "/home/dipayan/Anupam/CHASEDB/Little_AUNet/weights"
...
model_path = "/home/dipayan/Anupam/CHASEDB/Little_AUNet/weights"
...
plt.savefig('/home/dipayan/Anupam/CHASEDB/Little_AUNet.png')
plt.show()